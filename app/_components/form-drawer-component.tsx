...
export default function FormDrawerComponent({
  ...
  return (
    ...
    >
      <div className="relative flex max-h-[90dvh] min-h-[50dvh] w-full flex-col px-8 pt-12 pb-8">
        <div className="bg-secondary-light absolute top-6 left-1/2 h-1 w-16 -translate-x-1/2 rounded-full" />
        <div className="flex min-h-0 w-full flex-1 flex-col items-center justify-between overflow-y-auto">
          {children}
        </div>
      </div>
    </SwipeableDrawer>
