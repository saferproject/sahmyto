...
The public Reverb app key, host, port, and scheme are passed to the image by the deployment workflow. They are public browser configuration and currently target `wss://sahmyto.ir:443` with app key `gr2hzlrzrubqxztbloqe`.
